<script>
  ...
  $: baseCap = capacity >= 19000 ? 10000 : capacity >= 10000 ? 8000 : capacity >= 4000 ? 6000 : 4000;
  $: tierUplift = serviceTier === 'Ads + D2C + Creative' ? 2000
    : serviceTier === 'Ads + D2C or Creative' ? 1000 : 0;
  $: feeCap = baseCap + tierUplift;
    ...
    <div class="notes-content">
      <div class="notes-col">
        ...
        <ul>
          ...
          <li>Fee cap (Ads): £4,000 (&lt;4,000 cap) / £6,000 (4,000–9,999 cap) / £8,000 (10,000–18,999 cap) / £10,000 (19,000+ cap)</li>
          <li>Cap uplift: +£1,000 for Ads + D2C or Creative / +£2,000 for Ads + D2C + Creative</li>
